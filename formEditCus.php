                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="companyCode" id="companyCode" value="<?php echo $row["company_code"] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="companyName">Company Name:</label>
                                <input type="text" class="form-control" name="companyName" id="companyName" value="<?php echo $row["company_name"] ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-1.5">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="payment" id="payment">
                                    <option value="30" <?php echo ($row["payment"] == 30 ? "selected" : ""); ?>>30</optoin>
                                    <option value="60" <?php echo ($row["payment"] == 60 ? "selected" : ""); ?>>60</optoin>
                                    <option value="90" <?php echo ($row["payment"] == 90 ? "selected" : ""); ?>>90</optoin>
                                    <option value="120" <?php echo ($row["payment"] == 120 ? "selected" : ""); ?>>120</optoin>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="companyAddress[]" id="companyAddress" cols="30" rows="3"><?php echo $company_address[$i]->companyAddress; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
